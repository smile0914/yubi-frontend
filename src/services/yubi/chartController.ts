...
/** getChartAI POST /api/chart/gen */
export async function getChartAIUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getChartAIUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
/** getChartAIAsync POST /api/chart/gen/Async */
export async function getChartAIAsyncUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getChartAIAsyncUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
